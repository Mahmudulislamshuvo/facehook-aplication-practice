const NotFound = () => {
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#09090b] p-4 text-gray-100 font-inter">
      <div className="w-full max-w-md rounded-lg border border-[#3F3F3F] bg-[#18181b] px-8 py-10 text-center shadow-xl">
        {/* Icon */}
